...
namespace dae
{
	...
	class Scene_W4_Ref final : public Scene
	{
	public:
		Scene_W4_Ref() = default;
		~Scene_W4_Ref() override = default;

		Scene_W4_Ref(const Scene_W4_Ref&) = delete;
		Scene_W4_Ref(Scene_W4_Ref&&) noexcept = delete;
		Scene_W4_Ref& operator=(const Scene_W4_Ref&) = delete;
		Scene_W4_Ref& operator=(Scene_W4_Ref&&) noexcept = delete;
